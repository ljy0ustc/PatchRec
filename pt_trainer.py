...
class PTTrainer(SFTTrainer):
    def __init__(self, model=None, train_dataset=None, eval_dataset=None, data_collator=None, tokenizer=None, formatting_func=None, training_args=None, start_seq_token=None, end_seq_token=None, item_sep_token=None):
        super().__init__(
            model=model,
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        threshold = current_step/total_steps
