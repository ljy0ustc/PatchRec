...
class EvalCollator:
    ...
    def __call__(self, batch):
        ...
        for i, input_ids in enumerate(inputs['input_ids']):
            ...
            for j, (start_index, end_index) in enumerate(zip([start_seq_index]+sep_indices, sep_indices+[end_seq_index])):
...
def parser():
    ...
    parser.add_argument('--output_dir', default='output/ft-i', type=str)
    ...
    parser.add_argument('--item_len', type=int, default=3)
